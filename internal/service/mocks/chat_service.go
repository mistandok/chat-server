...
import (
	...
	service "github.com/mistandok/chat-server/internal/service"
)
...
// ConnectChat provides a mock function with given fields: _a0, _a1
func (_m *ChatService) ConnectChat(_a0 *model.ConnectChatIn, _a1 service.StreamChatMessageSender) error {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for ConnectChat")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(*model.ConnectChatIn, service.StreamChatMessageSender) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
